...
- [m-ou-se](https://github.com/m-ou-se), team member
  - m-ou-se needs no introduction - in addition to co-leading the library team, and being a member
    of the leadership council, m-ou-se makes various contributions to the compiler in her various
...
- [matthiaskrgr](https://github.com/matthiaskrgr), team member
  - matthiaskrgr has had a significant impact in the robustness of the compiler by regularly fuzzing
    the compiler to discover new bugs, contributing tests and making helpful refactorings.
